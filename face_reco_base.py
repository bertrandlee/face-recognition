...
class FaceRecognizer():
    def __init__(self):
        ...
        self.metadata = self.load_metadata('images')
        ...
        # Train images
        custom_metadata = self.load_metadata("custom")
...
if TEST_FACE_RECOGNIZER:
    ...
    face_recognizer.display_unknown_image("unknown/unknown6.jpg")
    
    example_idx = int(list(face_recognizer.targets).index("Brad_Pitt")/2)
    face_recognizer.display_image_prediction(example_idx)
